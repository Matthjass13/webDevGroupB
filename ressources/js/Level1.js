...
export class Level1 {
  ...
  update(modifier) {
    ...
    if (allCoinsCollected && this.key.collected) {
      console.log("All conditions met, switching to Level1 2"); // Debug message
      this.game.switchTo("Level1", 2, this.selectedCharacter); // Switch to the next level
    }
  }
