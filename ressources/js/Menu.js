...
export class Menu {
    constructor(ctx, game) {
        ...
        this.gameButton = new Button(this.ctx, "Start Game",
            ctx.canvas.width / 2 - 65, 350, () => this.game.switchTo("Level"));
        this.descriptionButton = new Button(this.ctx,"Description",
            ctx.canvas.width / 2 - 65, 390, () => this.drawDescription());
        this.rulesButton = new Button(this.ctx,"Rules",
            ctx.canvas.width / 2 - 65, 430, () => this.drawRules());
    }
